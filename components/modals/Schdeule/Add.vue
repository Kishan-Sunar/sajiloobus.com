                ...
                <div class="relative flex flex-col gap-y-4">
                    <header class="relative mb-3 w-full flex flex-row justify-between items-start gap-y-4">
                        <div class="flex flex-col gap-y-1">
                            <h3 class="text-xl font-semibold">Add schdeule</h3>
                        </div>
                        <button
                    ...
                    <div class="flex flex-col gap-y-3 mb-5">
                        <div>
                            ...
                            <base-input name="name" type="text" placeholder="Enter schdeule name"
                                class="h-14 px-14 pl-4">
                            </base-input>
                        </div>
                        <div>
                            <label class="mb-2 block font-medium text-sm">Choose Bus</label>
                            <base-dropdown-select :data="busData" name="bus" class="w-full h-14 border items-center"
                                optionValue="bus_no" optionLabel="name" />
                        </div>
                        <div class="grid gap-4 grid-cols-2">
                            <div>
                                <label class="mb-2 block font-medium text-sm">From</label>
                                <base-dropdown-select :data="locationData" name="origin"
                                    class="w-full h-14 border items-center" optionValue="id" optionLabel="name" />
                            </div>
                            <div>
                                <label class="mb-2 block font-medium text-sm">Departure Date/Time</label>
                                <base-input-datetimepicker name="departure" label="Departure date"
                                    class="w-full h-14 border items-center" />
                            </div>
                        </div>
                        <div class="grid gap-4 grid-cols-2">
                            <div>
                                <label class="mb-2 block font-medium text-sm">To </label>
                                <base-dropdown-select :data="locationData" name="destination"
                                    class="w-full h-14 border items-center" optionValue="id" optionLabel="name" />
                            </div>
                            <div>
                                <label class="mb-2 block font-medium text-sm">Arrival Date/Time</label>
                                <base-input-datetimepicker name="arrival" label="Departure date"
                                    class="w-full h-14 border items-center" />
                            </div>
                        </div>
                        <div>
                            <base-input name="fare" type="text" placeholder="Enter fare / seat" class="h-14 px-14 pl-4">
                            </base-input>
                        </div>
                        <div>
                            <base-textarea rows="5" name="policy" type="text" placeholder="Enter policy text"
                                class="px-14 pl-5">
                            </base-textarea>
                        </div>
                        <div>
                            <base-textarea rows="5" name="notes" type="text" placeholder="Write additional notes"
                                class="px-14 pl-5">
                            </base-textarea>
                        </div>

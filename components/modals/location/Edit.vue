            ...
            <div
                ...
                <div class="relative flex flex-col gap-y-4">
                    ...
                    <div class="flex flex-col gap-y-3 mb-5">
                        <base-input :input="selected.city" name="city" type="text" placeholder="Enter city name"
                            class="h-14 px-14">
                            <template #icon>
                                <Icon name="i-heroicons:pencil" size="25" class="absolute text-gray-500" />
                            </template>
                        </base-input>
                        <base-input :input="selected.city_code" name="city_code" type="text"
                            placeholder="Enter city short code" class="h-14 px-14">
                            <template #icon>
                                <Icon name="i-heroicons:pencil" size="25" class="absolute text-gray-500" />
                            </template>
                        </base-input>
                        <base-input :input="selected.name" name="name" type="text" placeholder="Enter location"
                            class="h-14 px-14">
                            <template #icon>
                                <Icon name="i-heroicons:pencil" size="25" class="absolute text-gray-500" />
                            </template>
                        </base-input>
                        <base-input :input="selected.lat" name="lat" type="text" placeholder="Enter latitude"
                            class="h-14 px-14">
                            <template #icon>
                                <Icon name="i-heroicons:pencil" size="25" class="absolute text-gray-500" />
                            </template>
                        </base-input>
                        <base-input :input="selected.lng" name="lng" type="text" placeholder="Enter longitude"
                            class="h-14 px-14">
                            <template #icon>
                                <Icon name="i-heroicons:pencil" size="25" class="absolute text-gray-500" />
                            </template>

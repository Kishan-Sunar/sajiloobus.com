                    ...
                    <div class="mb-4 col-span-2">
                        ...
                        <div class="px-4 sm:px-6 py-5">
                            <div class="grid grid-cols-2 gap-x-4 gap-y-6">
                                <div>
                                    <label class="text-slate-500 mb-2 block font-medium text-sm">Full Name</label>
                                ...
                                <div>
                                    <label class="text-slate-500 mb-2 block font-medium text-sm">Email Address</label>
                                    <base-input :input="user.email" name="email" type="email" placeholder="Email"
                                        class="h-14 px-14">
                                        <template #icon>
                                ...
                                <div>
                                    ...
                                    <base-select name="gender">
                                        ...
                                        <template #options>
                                            ...
                                            <option value="female" :selected="passenger.gender == 'female'">Female
                                            </option>

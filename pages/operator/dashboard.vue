        ...
        <div class="container mx-auto">
            ...
            <div class="border mb-5 grid sm:grid-cols-3 rounded-xl">
                ...
                >
                    ...
                    <div>
                        <h4 class="text-2xl font-semibold">NPR 22,000</h4>
                    </div>
                </div>
                <div
                    class="sm:border-r sm:border-l border-t border-b sm:border-t-0 sm:border-b-0 py-5 px-4"
                >
                    <span class="font-medium">New Bookings</span>
                    <div>
                        <h4 class="text-2xl font-semibold">22+</h4>
                    </div>
                </div>
                <div
                    class="rounded-b-xl sm:rounded-b-0 sm:rounded-r-xl py-5 px-4"
                >
                    <span class="font-medium">Total Bookings</span>
                    <div>
                        <h4 class="text-2xl font-semibold">12000+</h4>
                    </div>
                </div>
            </div>
            <div class="py-5">
                <div class="grid grid-cols-2">
                    <div class="py-4 px-4 bg-slate-100 rounded-xl">
                        ...
                        <div v-for="item in [1, 2, 3, 4, 5]" :key="item">
                            <div
                                class="px-2 rounded-full relative hover:bg-slate-50"
                            >
                                <div
                                    class="grid gap-y-3 sm:grid-cols-[minmax(min-content,50px)_1fr]"
                                >
                                    <div class="py-2">
                                        <div
                                    ...
                                    <div class="px-0 py-2 sm:px-6">
                                        <div
                                            class="grid grid-cols-2 sm:grid-cols-3 gap-y-2 gap-x-6"
                                        >
                                            <div class="flex flex-col">
                                                <div class="relative pl-5">
                                                    <i
                                                        class="absolute rounded-full left-0 top-[8px] w-2 h-2 bg-green-600"
                                                    ></i>
                                                    <span
                                                ...
                                                <div class="relative pl-5">
                                                    <i
                                                        class="absolute left-0 top-[8px] w-2 h-2 bg-orange-500"
                                                    ></i>
                                                    <span
                                                        class="text-xs font-medium"
                                                        >Kaski, Pokhara</span

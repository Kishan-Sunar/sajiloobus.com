...
<template>
    <header class="py-4 pb-10 container mx-auto flex justify-between items-center bg-green-600">
        <h3 class="text-xl text-white font-semibold">Manage Bus</h3>
        <button
    ...
    <div class="bg-white rounded-t-3xl py-5 -mt-6">
        <div class="container mx-auto">
            ...
            <div class="flex flex-col gap-y-1">
                <div v-for="item in [1, 2, 3, 4, 5]" :key="item" class="py-4">
                    <div class="grid gap-y-3 sm:grid-cols-[minmax(min-content,80px)_1fr]">
                        <div>
                            <div class="w-[50px] h-[50px] bg-slate-400 block rounded-full overflow-hidden shadow-lg">
                        ...
                        <div class="pb-4 border-b">
                            <div class="grid grid-cols-2 sm:grid-cols-3 gap-y-2 gap-x-6">
                                <div class="flex flex-col gap-y-1">
                                    <h2 class="text-sm font-medium text-slate-500">Registration Number</h2><span
                                        class="text-base font-medium">Ba 4 Pa 2023</span>
                                </div>
                                <div class="flex flex-col gap-y-1">
                                    <h2 class="text-sm font-medium text-slate-500">Bus Type</h2><span
                                        class="text-base font-medium">Sleeper seater | 2+ 1</span>
                                </div>
    ...
    <ClientOnly>
        <Teleport to="#infobar">
            <div class="px-4 bg-amber-100 py-4">
                Your subscription has been expired. Please renew the subscription
            </div>
        </Teleport>
    </ClientOnly>
</template>
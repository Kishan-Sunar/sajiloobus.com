...
<template>
    <header class="py-4 pb-10 container mx-auto flex justify-between items-center bg-green-600">
        <h3 class="text-xl text-white font-semibold">Manage Cities</h3>
        <nuxt-link to="/operator/manage-cities/add"
    ...
    <div class="bg-white rounded-t-3xl py-5 -mt-6">
        <div class="container mx-auto">
            <header class="flex items-center justify-between">
                <h4 class="font-medium text-lg">20/ 200 Cities</h4>
                <div class="relative">
            ...
            <div class="flex flex-col gap-y-1">
                <div v-for="item in      ['Pokhara', 'Kathmandu', 'Birgunj', 'Surkhet', 'Hetauda']     " :key="item"
                    class="py-4">
                    <div class="pb-4 border-b">
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-y-2 gap-x-6">
                            <div class="flex flex-col gap-y-1">
                                <h2 class="text-sm font-medium text-slate-500">District</h2>
                                <span class="text-base font-medium">Gandaki</span>
                            </div>
                            <div class="flex flex-col gap-y-1">
                                <h2 class="text-sm font-medium text-slate-500">City</h2>
                                <span class="text-base font-medium">{{ item }}</span>
                            </div>
                            <div class="flex flex-col gap-y-1">
                                <h2 class="text-sm font-medium text-slate-500">Boarding / Dropping Point</h2>
                                <nuxt-link to="/operator/manage-cities/1/"
                                    class="text-base text-blue-600 hover:underline">
                                    Manage
                                </nuxt-link>
                            </div>
                            <div class="flex justify-end gap-y-1">
                                <SharedActionButton @action="navigateTo('/operator/manage-cities/edit-1')">
                                    <IconEdit class="h-5" />
                                </SharedActionButton>
                                <SharedActionButton>
